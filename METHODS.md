...
- **End-to-end inversion error**: measured by feeding GIBS's authoritative
  ...
  follows the colormap GIBS renders with. Aerosol and soil moisture take their
  ...
  ramp never yields a value at all. **Absolute values for temperature and
  precipitation carry large uncertainty; use the probe for

...
26 years of vegetation, snow, and temperature composites (some layers back to 1980) — seasons, droughts, and trends emerge visually. Students can click any
point on the globe and download the time series as a CSV for a lab exercise;
there are step-by-step "research recipes" in the docs.

 ...
 * each mean covers its drawn cells alone and that an undrawn share is not
 * evidence of dry ground. `summarizeGldasAveragedSupport` already refuses to
 ...
 * 100%. Only an exact 1 prints "100%", matching vegetationAveragedSupport.ts,
 * which formats the same share for the same sampler.
 */
